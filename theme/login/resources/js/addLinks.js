...
window.onload = () => {
  ...
  form.insertAdjacentHTML('beforeend',`
    ...
    <div style="
      ...
      color: gray;
    ">
      <a target="_blank" href="https://wiki.netsoc.co/en/services/acceptable-usage-policy">Acceptable Usage Policy</a>
      <span> &bull; </span>
  ...
  <div style="
    ...
    margin-bottom: 16px;
  ">
    <p>if you had signed up to netsocadmin prior to the 2020/2021 academic year, you will need to <a target="_blank" href="https://admin.netsoc.co/account/password-reset">reset your password</a></p>
  </div>`
}
